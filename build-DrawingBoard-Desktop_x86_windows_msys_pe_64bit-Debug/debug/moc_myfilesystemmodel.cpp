...
#include <memory>
#include "../../DrawingBoard/myfilesystemmodel.h"
...
struct qt_meta_stringdata_MyFileSystemModel_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MyFileSystemModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MyFileSystemModel_t qt_meta_stringdata_MyFileSystemModel = {
    {
QT_MOC_LITERAL(0, 0, 17) // "MyFileSystemModel"
...
QT_INIT_METAOBJECT const QMetaObject MyFileSystemModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QFileSystemModel::staticMetaObject>(),
    qt_meta_stringdata_MyFileSystemModel.data,
    qt_meta_data_MyFileSystemModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MyFileSystemModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MyFileSystemModel.stringdata0))
